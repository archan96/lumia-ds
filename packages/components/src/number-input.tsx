...
const inputClasses =
  'flex-1 bg-transparent px-3 py-2 placeholder:text-muted focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50';

const controlsClasses = 'flex w-11 flex-col border-l border-border';

const controlButtonClasses =
  'flex flex-1 items-center justify-center text-muted transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50';
    ...
    return (
      <div className={fieldWrapperClasses}>
        <div
          className={cn(
            wrapperClasses,
            invalid && [invalidFieldClasses, 'focus-within:ring-destructive'],
